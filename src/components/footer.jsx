  ...
  return (
    <footer className="bg-background text-white py-4 border-t-2">
      {/* <div className="container mx-auto text-center">
        <span className='text-black dark:text-white'>Made by <a
          href="https://github.com/FrancisCodex"
          target="_blank"
          rel="noopener noreferrer"
          className="text-blue-600 hover:text-primary dark:text-primary dark:hover:text-blue-600" 
        >
         FrancisCodex
        </a> with Love 💓</span>
      </div> */}
  ...
  <div className="flex flex-col mx-2 rounded-lg">
    <div className="w-full draggable">
      <div className="flex flex-col mx-auto">
        <div className="flex flex-col items-center w-full my-5 gap-y-3">
          <img src={isDarkMode ? OJT_Logo_withText_Dark : OJT_Logo_withText} alt="OnTheJob Logo" className="h-8" />
          <div className="flex flex-col items-center gap-6 mb-8">
            <div className="flex flex-wrap items-center justify-center gap-5 lg:gap-12 gap-y-3 lg:flex-nowrap text-dark-grey-900">
              <a href="#" className="text-black dark:text-white">About</a>
              <a href="#" className="text-black dark:text-white">Features</a>
              <a href="#" className="text-black dark:text-white">Blog</a>
              <a href="#" className="text-black dark:text-white">Resources</a>
              <a href="#" className="text-black dark:text-white">Partners</a>
              <a href="#" className="text-black dark:text-white">Help</a>
              <a href="#" className="text-black dark:text-white">Terms</a>
            </div>
            <div className="flex items-center gap-8">
              <a href="javascript:void(0)" className="text-black dark:text-white">
          ...
          <div className="flex items-center">
            <span className='text-black dark:text-white'>2024 Made by <a
          href="https://github.com/FrancisCodex"
          target="_blank"
          rel="noopener noreferrer"
          className="text-blue-600 hover:text-primary dark:text-primary dark:hover:text-blue-600" 
